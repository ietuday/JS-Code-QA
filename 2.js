 ...
 * first example.In the second loop, the variable i was declared using 
 * the let keyword: variables declared with the let (and const) keyword 
 * are block-scoped (a block is anything between { }). During each 
 * iteration, i will have a new value, and each value is scoped inside 
 * the loop.